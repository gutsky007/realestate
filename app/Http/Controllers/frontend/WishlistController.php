...
class WishlistController extends Controller
{
    ...
    public function deleteWishlistItem(Request $request, $propertyId){
        // Delete the wishlist item from the database
        Wishlist::where('user_id', Auth::id())->where('property_id', $propertyId)->delete();
        return response()->json(['success' => 'Wishlist item deleted successfully']);
    }//End Method
