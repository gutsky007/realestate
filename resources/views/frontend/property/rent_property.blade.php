                                ...
                                <div class="widget-content">
                                    ...
                                    <div class="select-box">
                                        <select name="ptype_id" class="wide">
                                            <option data-display="Property Type" selected="" disabled="" >Select Type</option>  
                                    ...
                                    <div class="select-box">
                                        <select name="bedrooms" class="wide">
                                            <option data-display="Number of Rooms">Max Rooms</option>
                                    ...
                                    <div class="select-box">
                                        <select name="bathrooms" class="wide">
                                            <option data-display="Number of Bathrooms">Max Bathroom</option>
