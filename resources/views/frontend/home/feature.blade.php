...
<section class="feature-section sec-pad bg-color-1">
    <div class="container">
        ...
        <div class="row justify-content-center"> <!-- Centers the columns horizontally -->

            @foreach($property as $item)
            <div class="col-lg-4 col-md-6 col-sm-12 feature-block mb-4"> <!-- Adds spacing at the bottom to prevent squishing -->
